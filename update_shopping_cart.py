...
file_path = "c:/Projects/MakeMyPC/js/shopping-cart.js"
...
function renderCheckoutUI() {
    ...
    cartData.forEach((build, index) => {
        ...
        buildsHtml += `
            <div class="mb-8">
                <!-- Build Card Redesign -->
                <div class="glass-card rounded-2xl border border-white/10 overflow-hidden mb-8 shadow-lg">
                            ...
                            <div>
                                ...
                                <div class="flex justify-between items-start mb-2">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <button class="w-8 h-8 rounded border border-white/10 hover:bg-white/10 flex items-center justify-center transition-colors">
                                        ...
                                        <button onclick="window.toggleBuildDetails(${index})" class="w-8 h-8 rounded border border-white/10 hover:bg-white/10 flex items-center justify-center transition-colors">
                                            <span id="icon-build-${index}" class="material-symbols-outlined text-[20px] text-on-surface-variant transform transition-transform duration-300 rotate-180">expand_more</span>
                                        </button>
                                    </div>
                                </div>
                ...
                <div id="details-build-${index}" class="grid grid-rows-[1fr] transition-[grid-template-rows] duration-500 ease-[cubic-bezier(0.4,0,0.2,1)]">
...
print("Updated shopping-cart.js successfully.")

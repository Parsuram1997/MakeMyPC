            ...
            <div class="glass-card rounded-xl p-6 flex flex-col md:flex-row items-center gap-8 group transition-all ${isSelected ? 'border-primary shadow-[0_0_20px_rgba(0,122,255,0.2)]' : ''}">
                ...
                <div class="flex-1 w-full">
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="https://amazon.in/s?k=${encodeURIComponent(part.brand + ' ' + part.model)}" target="_blank" title="Buy on Amazon" class="h-12 w-24 flex-shrink-0 flex items-center justify-center bg-white border border-white/10 rounded-lg hover:bg-gray-100 transition-all group/amz shadow-sm px-2">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/a/a9/Amazon_logo.svg" alt="Amazon" class="w-full h-7 object-contain group-hover/amz:scale-105 transition-transform">
                        </a>

                        <a href="https://www.flipkart.com/search?q=${encodeURIComponent(part.brand + ' ' + part.model)}" target="_blank" title="Buy on Flipkart" class="h-12 w-24 flex-shrink-0 flex items-center justify-center bg-white border border-white/10 rounded-lg hover:bg-gray-100 transition-all group/fk shadow-sm px-2">
                            <img src="images/flipkart-full.png" alt="Flipkart" class="w-full h-7 object-contain group-hover/fk:scale-105 transition-transform">
                        </a>
